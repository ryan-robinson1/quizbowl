      ...
      <div class="row">
         <div class="card col-md-6 p-5 border-0">
            <div class="card-body p-5 border border-primary border-3 rounded">
               ...
               <h4 class="p-4">Last question: <?php echo $blue_last; ?> </h5>
            </div>
         </div>
         ...
         <div class="card col-md-6 p-5 border-0">
            <div class="card-body p-5 border border-danger border-3 rounded">
               ...
               <h4 class="p-4">Last question: <?php echo $red_last; ?> </h5>
            </div>
         </div>
      </div>
   </div>
      ...
      <div class="row p-5">
         <form action="?command=in_session" method="post">
            <div class="text-center">
               <button type="submit" class="btn btn-success" style="font-size:40px"><span>Next question</span></button>
            </div>
         </form>
